...
def get_ptc_residues(struct:Structure, pdbid:str)->List[Residue]:
    PTC_CONSERVED_NUCLEOTIDES=['2055','2451','2452','2504','2505','2506','2507']
    def belongs_to_ptc(x:Residue):
        return str(x.get_id()[1]) in PTC_CONSERVED_NUCLEOTIDES
