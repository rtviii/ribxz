...
# A script to add a given structure to the database
# The cypher cli is used 
#! Schema must conform to the one in 'RibosomeTypes.ts' (master-record)
# Specify the credentials below
